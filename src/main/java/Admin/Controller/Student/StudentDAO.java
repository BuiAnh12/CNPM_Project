...
//    }
    ...
    public ArrayList<StudentModel> getTable(int filterCategory, String searchWords, String typeRange) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, dbUsername, dbPassword)) { String sql = "SELECT * FROM Student WHERE  Enable <> 0 AND Fullname LIKE ? " + typeRange;
